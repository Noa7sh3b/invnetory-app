...
def apply_theme():
    st.markdown(
        ...
        /* ── Sidebar: clean, collapse-friendly ── */
        ...
        /* Streamlit collapse/expand button — leave it alone, just style it */
        ...
        div[data-baseweb="select"] > div:focus-within {
            border-color: #1e90ff !important;
            box-shadow: 0 0 0 1px #1e90ff !important;
        /* Sidebar Styling (Safe Version – keeps collapse working) */
        [data-testid="stSidebar"] {
             background: #0f1115;
             border-right: 1px solid var(--border);
             width: 280px;
        ...
        /* Do NOT hide collapsed control */
        /* Removed forced width, transform, display, visibility, left overrides */

        /* Force blue focus for all inputs */
        input:focus,
        textarea:focus,
        select:focus,
        [data-baseweb="input"] input:focus,
